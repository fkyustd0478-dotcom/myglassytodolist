...
const _defaultExercises = () => [
    ...
    // Snatch
    { id: _wUid(), name: 'Hang Power Snatch',          nameZh: '膝上爆發抓',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Hang Snatch',                nameZh: '膝上抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Panda Pull',                 nameZh: '熊貓拉',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Hang Snatch High Pull',      nameZh: '膝上高拉',         categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Low Hang Power Snatch',      nameZh: '膝下爆發抓',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Low Hang Snatch',            nameZh: '膝下抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Low Panda Pull',             nameZh: '低位熊貓拉',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    ...
    { id: _wUid(), name: 'Dip Power Snatch',           nameZh: '拋位爆發抓',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Dip Snatch',                 nameZh: '拋位抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Tall Snatch',                nameZh: '高位抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Dip Snatch High Pull',       nameZh: '拋位高拉',         categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Power Snatch',               nameZh: '爆發抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch',                     nameZh: '抓',               categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Muscle Snatch',              nameZh: '肌肉抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Contact Muscle Snatch',   nameZh: '無接觸肌肉抓',     categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch Deadlift',            nameZh: '抓舉硬拉',         categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch Deadlift and Pull',   nameZh: '抓舉硬拉加拉',     categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Feet Power Snatch',       nameZh: '無步爆發抓',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Feet Snatch',             nameZh: '無步抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Contact Power Snatch',    nameZh: '無接觸爆發抓',     categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Power Snatch',           nameZh: '箱上爆發抓',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Snatch',                 nameZh: '箱上抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Panda Pull',             nameZh: '箱上熊貓拉',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Snatch High Pull',       nameZh: '箱上高拉',         categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Snatch Deadlift',        nameZh: '箱上抓舉硬拉',     categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Block Power Snatch',         nameZh: '墊上爆發抓',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Block Snatch',               nameZh: '墊上抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Block Snatch Deadlift',      nameZh: '墊上抓舉硬拉',     categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch Balance',             nameZh: '抓舉蹲',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch Push Press',          nameZh: '抓舉推壓',         categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Drop Snatch',                nameZh: '落蹲抓',           categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch Press',               nameZh: '抓舉推舉',         categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Snatch Press in Middle Grip',nameZh: '中握抓舉推',       categories: ['Snatch'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    // Clean&Jerk
    { id: _wUid(), name: 'Hang Power Clean',           nameZh: '膝上爆發上膊',     categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Hang Clean',                 nameZh: '膝上上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Hang Clean High Pull',       nameZh: '膝上高拉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Hang Clean Panda Pull',      nameZh: '膝上熊貓拉',       categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Low Hang Power Clean',       nameZh: '膝下爆發上膊',     categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Low Hang Clean',             nameZh: '膝下上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    ...
    { id: _wUid(), name: 'Low Hang Clean Panda Pull',  nameZh: '膝下熊貓拉',       categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Dip Power Clean',            nameZh: '拋位爆發上膊',     categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Dip Clean',                  nameZh: '拋位上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Tall Clean',                 nameZh: '高位上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Dip Clean High Pull',        nameZh: '拋位高拉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Power Clean',                nameZh: '爆發上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Clean',                      nameZh: '上膊',             categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Deadlift',                   nameZh: '硬拉',             categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Deadlift and Pull',          nameZh: '硬拉加拉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Feet Power Clean',        nameZh: '無步爆發上膊',     categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Feet Clean',              nameZh: '無步上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Muscle Clean',               nameZh: '肌肉上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'No Contact Muscle Clean',    nameZh: '無接觸肌肉上膊',   categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Power Clean',            nameZh: '箱上爆發上膊',     categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Clean',                  nameZh: '箱上上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Clean High Pull',        nameZh: '箱上高拉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Clean Panda Pull',       nameZh: '箱上熊貓拉',       categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Box Deadlift',               nameZh: '箱上硬拉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Block Power Clean',          nameZh: '墊上爆發上膊',     categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Block Clean',                nameZh: '墊上上膊',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Block Deadlift',             nameZh: '墊上硬拉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Clean & Jerk',               nameZh: '上挺',             categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Rack Jerk',                  nameZh: '架上挺',           categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Behind the Neck Jerk',       nameZh: '頸後挺',           categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Push Jerk',                  nameZh: '推蹲挺',           categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Power Jerk',                 nameZh: '爆發挺',           categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Squat Jerk',                 nameZh: '蹲挺',             categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Push Press',                 nameZh: '推舉',             categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Military Press',             nameZh: '軍事推舉',         categories: ['Clean&Jerk'], type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    // Squat
    ...
    { id: _wUid(), name: 'Overhead Squat',             nameZh: '過頭蹲',           categories: ['Squat'],      type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Barbell Split Squat',        nameZh: '槓鈴弓步蹲',       categories: ['Squat'],      type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    // WL Back
    ...
    { id: _wUid(), name: 'Bent-over Row',              nameZh: '俯身划船',         categories: ['WL Back'],    type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Dumbbell Row',               nameZh: '啞鈴划船',         categories: ['WL Back'],    type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    // WL Legs
    { id: _wUid(), name: 'Romanian Deadlift',          nameZh: '羅馬尼亞硬拉',     categories: ['WL Legs'],    type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    // Bodybuilding Back (new)
    { id: _wUid(), name: 'Face Pull',                  nameZh: '臉部拉索',         categories: ['Back'],       type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Lat Pulldown',               nameZh: '高位下拉',         categories: ['Back'],       type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Wide Grip Lat Pulldown',     nameZh: '寬握高位下拉',     categories: ['Back'],       type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Close Grip Lat Pulldown',    nameZh: '窄握高位下拉',     categories: ['Back'],       type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Reverse Grip Lat Pulldown',  nameZh: '反握高位下拉',     categories: ['Back'],       type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
    { id: _wUid(), name: 'Cable Pull-over',            nameZh: '繩索直臂下拉',     categories: ['Back'],       type: 'sets', preferredUnit: 'kg', description: '', targetMuscles: '' },
];
